...
export default function ActivityTable(props) {
    ...
    return (
        <Box sx={{ width: '100%', border: "1px solid #E1E1E126", padding: 1, borderRadius: 5, maxHeight: 600, overflow: "scroll" }}>
                                    ...
                                    data?.map((row, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell align="right">{row.seller?.displayName ?? "-"}</TableCell>
                                                ...
                                                <TableCell style={{ borderTopRightRadius: 20, borderBottomRightRadius: 20, }} align="right">
                                                    <Link target='_blank' href={`${TRANSACTION_ENDPOINT}/tx/${row?.hash}`} >
                                                        {moment(new Date(parseInt(row.createdAt))).format('DD/MM/YYYY, hh:mm A')} <LaunchIcon />
                                                    </Link>
                                                </TableCell>
                                            </TableRow>
                                        );
